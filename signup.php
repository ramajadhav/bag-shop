...
<form action="" method="post" style="border:1px solid #ccc;margin-top:5%;padding:0;">
  <div class="container">
    <h1>Sign Up</h1>
...
if(isset($_POST['signup']))
{
  ...
  {
    $status=1;
    $qry = mysqli_query($conn,"INSERT INTO `signup`(`fname`, `lname`, `email`, `upass`, `state`, `zipcode`, `address`, `phone`,`STATUS`) VALUES ('$fname','$lname','$email','$pass','$state','$zcode','$add','$phone','$status')");
    if($qry)
    {
